...
public:
  ...
  AudioSink(const float samplerate = oboe::Unspecified, const size_t buffersize = oboe::Unspecified, const std::shared_ptr<AudioEffect> effect = nullptr, const std::shared_ptr<AudioBufferQueue> queue = nullptr);
